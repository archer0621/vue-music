...
<script>
import SongTable from "@/components/common/songlist/SongTable.vue";
import SongCollect from "@/components/common/songlist/SongCollect.vue";
import SongComment from "@/components/common/songlist/SongComment.vue";
